...
//  importsDateInScope() // will work
  ...
  println("***************************")
  val animal1 = new Lion("Leo")
  animal1.eat
  animal1.roar
  println(animal1.name)

  val animal2: Animal = new Lion("Aah")
  animal2.eat
//  animal2.roar // wont work cos type of animal 2 is Animal not Lion

  val animal3 = new Animal("lee") // we can instantiate cos Animal isn't abstract
}
